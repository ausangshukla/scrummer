...
class SprintsControllerTest < ActionController::TestCase
  ...
  test "should create sprint" do
    assert_difference('Sprint.count') do
      post :create, sprint: { end_date: @sprint.end_date, iteration: @sprint.iteration, notes: @sprint.notes, project_id: @sprint.project_id, rag_status: @sprint.rag_status, start_date: @sprint.start_date }
    end
  ...
  test "should update sprint" do
    patch :update, id: @sprint, sprint: { end_date: @sprint.end_date, iteration: @sprint.iteration, notes: @sprint.notes, project_id: @sprint.project_id, rag_status: @sprint.rag_status, start_date: @sprint.start_date }
    assert_redirected_to sprint_path(assigns(:sprint))
  end
